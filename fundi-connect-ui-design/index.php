            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    ...
                    <div class="search-box mb-4">
                        ...
                        <input type="text" class="form-control-custom" placeholder="Your Location (e.g., Kampala)">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-card">
                        ...
                        <div class="service-card-body">
                            ...
                            <a href="#" class="btn btn-outline-gold btn-sm">Find Plumbers <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-card">
                        ...
                        <div class="service-card-body">
                            ...
                            <a href="#" class="btn btn-outline-gold btn-sm">Find Electricians <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-card">
                        ...
                        <div class="service-card-body">
                            ...
                            <a href="#" class="btn btn-outline-gold btn-sm">Find Carpenters <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-card">
                        ...
                        <div class="service-card-body">
                            ...
                            <a href="#" class="btn btn-outline-gold btn-sm">Find Painters <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-card">
                        ...
                        <div class="service-card-body">
                            ...
                            <a href="#" class="btn btn-outline-gold btn-sm">Find Cleaners <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-card">
                        ...
                        <div class="service-card-body">
                            ...
                            <a href="#" class="btn btn-outline-gold btn-sm">View All <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section section-darker" id="fundis">
        <div class="container">
            ...
            <div class="text-center mt-5">
                <a href="#" class="btn btn-gold btn-lg">View All Fundis <i class="bi bi-arrow-right ms-2"></i></a>
            </div>
        </div>
    </section>
    ...
    <section class="section section-dark" style="background: linear-gradient(135deg, rgba(212, 175, 55, 0.1) 0%, var(--black) 100%);">
        <div class="container text-center">
            ...
            <div class="d-flex gap-3 justify-content-center flex-wrap">
                <a href="register.php" class="btn btn-gold btn-lg">Find a Fundi</a>
                <a href="register.php?role=fundi" class="btn btn-outline-gold btn-lg">Join as a Fundi</a>
            </div>
        </div>
    </section>
